  ...
  return (
    ...
    >
      <div className="w-[480px] h-[655px] bg-[#FFF] flex flex-col justify-between p-[32px] items-start rounded-2xl">
          ...
          <div className="mt-5 w-[400px]">
            ...
            <div>
              ...
              <input
                ...
                className={`w-104 h-11 p-[12px] rounded-[8px] border-[#8B8E95] border-2 text-black + ${
        ...
        {preview ? (
          <img className="w-full h-52" src={preview} />
        ) : (
          <div className="bg-[#7F7F800D] flex flex-col w-full h-52 justify-center items-center relative text-black">
            <img src="image.svg" />
            Add image
            <input
              type="file"
